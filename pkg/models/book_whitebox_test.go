...
func TestJSONMarshal(t *testing.T) {
	...
	// For reasons beyond our understanding this puts each object as... base64???
...
/*func TestJSONUnmarshal(t *testing.T) {
	singleJsonBooks := [][]byte{[]byte(`{"id":"01953a93-21e7-73da-8a27-fc22aa66a95e","isbns":[{"type":"isbn10","value":"0141439602"},{"type":"isbn13","value":"9780141439600"}],"title":"A Tale of Two Cities","author":"Charles Dickens","published":"1859-11-26"}`),
